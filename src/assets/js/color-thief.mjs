...
var r = (function () {
        ...
        function a(t, r, n, o, e, u, a) {
            var i = this
            ;(i.r1 = t), (i.r2 = r), (i.g1 = n), (i.g2 = o), (i.b1 = e), (i.b2 = u), (i.histo = a)
        }
        function i() {
        ...
        function c(r, n) {
            if (n.count()) {
                ...
                if (a == o)
                    for (i = n.r1; i <= n.r2; i++) {
                        for (s = 0, c = n.g1; c <= n.g2; c++) for (f = n.b1; f <= n.b2; f++) s += r[e(i, c, f)] || 0
                        v[i] = h += s
                    }
                else if (a == u)
                    for (i = n.g1; i <= n.g2; i++) {
                        for (s = 0, c = n.r1; c <= n.r2; c++) for (f = n.b1; f <= n.b2; f++) s += r[e(c, i, f)] || 0
                        v[i] = h += s
                    }
                else
                    for (i = n.b1; i <= n.b2; i++) {
                        for (s = 0, c = n.r1; c <= n.r2; c++) for (f = n.g1; f <= n.g2; f++) s += r[e(c, f, i)] || 0
                        v[i] = h += s
                    }
                return (
                            ...
                            if (v[i] > h / 2) {
                                for (
                                    e = n.copy(),
                                        ...
                                        a =
                                            (r = i - n[c]) <= (o = n[f] - i)
                                                ? Math.min(n[f] - 1, ~~(i + o / 2))
                                                : Math.max(n[c], ~~(i - 1 - r / 2));
                                    !v[a];
            ...
            (a.prototype = {
                ...
                count: function (t) {
                    ...
                    if (!r._count_set || t) {
                        var o,
                            ...
                            i = 0
                        for (o = r.r1; o <= r.r2; o++)
                            for (u = r.g1; u <= r.g2; u++) for (a = r.b1; a <= r.b2; a++) i += n[e(o, u, a)] || 0
                ...
                contains: function (t) {
                    ...
                    return (
                        (gval = t[1] >> n),
                        (bval = t[2] >> n),
                        o >= r.r1 && o <= r.r2 && gval >= r.g1 && gval <= r.g2 && bval >= r.b1 && bval <= r.b2
                    )
                }
            }),
            (i.prototype = {
                ...
                nearest: function (t) {
                    for (var r, n, o, e = this.vboxes, u = 0; u < e.size(); u++)
                        ((n = Math.sqrt(
                            Math.pow(t[0] - e.peek(u).color[0], 2) +
                                Math.pow(t[1] - e.peek(u).color[1], 2) +
                                Math.pow(t[2] - e.peek(u).color[2], 2)
                        )) < r ||
                            void 0 === r) &&
                            ((r = n), (o = e.peek(u).color))
                    return o
                },
                forcebw: function () {
                    var r = this.vboxes
            ...
            }),
            {
                quantize: function (f, s) {
                    ...
                    var v = (function (t, r) {
                            ...
                            return (
                                t.forEach(function (t) {
                                    ;(o = t[0] >> n) < i ? (i = o) : o > c && (c = o),
                                        (e = t[1] >> n) < f ? (f = e) : e > s && (s = e),
                                        (u = t[2] >> n) < h ? (h = u) : u > v && (v = u)
                                }),
                                new a(i, c, f, s, h, v, r)
                            )
                        })(f, h),
                        l = new u(function (r, n) {
                    ...
                    for (
                        ...
                        p.push(l.pop())
                    g(p, s)
                    for (var b = new i(); p.size(); ) b.push(p.pop())
                    return b
                }
            }
        )
...
;(o.prototype.getColor = function (t, r) {
    ...
    (o.prototype.getPalette = function (t, o, e) {
        var u = (function (t) {
            ...
            a = new n(t),
            i = (function (t, r, n) {
                for (var o, e, u, a, i, c = t, f = [], s = 0; s < r; s += n)
                    (e = c[0 + (o = 4 * s)]),
                        (u = c[o + 1]),
                        (a = c[o + 2]),
                        (void 0 === (i = c[o + 3]) || i >= 125) &&
                            ((e > 250 && u > 250 && a > 250) || f.push([e, u, a]))
                return f
            })(a.getImageData().data, a.width * a.height, u.quality),
            c = r(i, u.colorCount)
