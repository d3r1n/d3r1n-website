<template>
    ...
    <div class="profile-info w-auto flex flex-col flex-items-start flex-content-center gap-4">
            ...
            <span class="divider inline-block w-1 h-1 rounded-full bg-slate-300 dark:bg-neutral-800"></span>
            ...
            <span class="links w-full flex items-center justify-start gap-4">
                ...
                <a class="group sc-social-link" href="https://github.com/d3r1n">
                    <GitHub class="sc-link-svg"/>
                </a>

                <a class="group sc-social-link" href="https://linkedin.com/in/d3r1n">
                    <LinkedIn class="sc-link-svg"/>
                </a>

                <a class="group sc-social-link" href="https://discord.com/users/704758931343278162">
                    <Discord class="sc-link-svg"/>
                </a>
            </span>
        </div>

        <img :src="user.avatar" alt="" class="profile-avatar rd-2 w-64 shadow-lg shadow-avatar-color">
    </div>
</template>
