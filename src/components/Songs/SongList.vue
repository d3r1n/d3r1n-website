<template>
    <div class="top-tracks sc-flex-center flex-col gap-10">
        <h1 class="m-0 text-3xl tracking-wide font-roboto text-slate-800 dark:text-neutral-200">Top Tracks</h1>
    ...
    <div class="top-artists sc-flex-center flex-col gap-10">
        <h1 class="m-0 text-3xl tracking-wide font-roboto text-slate-800 dark:text-neutral-200">Top Artists</h1>
