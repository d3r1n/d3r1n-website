<template>
    <div class="donation font-nunito w-max sc-flex-center flex-col p-5 rd-4 gap-2 bg-slate-300 dark:bg-neutral-800">
        ...
        <p class="text-base font-nunito w-64 text-slate-700 dark:text-neutral-200">
            ...
            I want to study Computer Science in USA or Canada.
        </p>
        <a href="https://ko-fi.com/d3r1n" target="_blank" class="no-underline text-xl font-bold px-6 py-3 text-slate-100 bg-blue-500 transition-all duration-300 hover:bg-emerald-500 rd-full hover:scale-110">Ko-Fi</a>
    </div>
</template>